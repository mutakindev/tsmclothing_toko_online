...
Route::group(['middleware' => ['auth','checkRole:customer']],function(){
    ...
    Route::post('/wishlist/update','user\WishlistController@update')->name('user.wishlist.update');
    Route::get('/wishlist/delete/{id}','user\WishlistController@delete')->name('user.wishlist.delete');
    Route::post('/wishlist/simpan','user\WishlistController@simpan')->name('user.wishlist.simpan');
