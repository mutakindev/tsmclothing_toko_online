                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="product-thumbnail">
                                <img src="{{ asset('storage/'.$keranjang->image) }}" alt="Image" class="img-fluid"
                                    width="150">
                            </td>
                            ...
                            <td>
                                <h2 class="h5 text-black">{{ $keranjang->size }}</h2>
                            </td>
                            <?php
                ...
                <div class="row justify-content-end">
                    <div class="col-md-12">
                        ...
                        <div class="row">
                            ...
                            @else
                            <div class="col-md-12">
                                <a href="{{ route('user.alamat') }}" class="btn btn-primary btn-lg py-3 btn-block">Atur
                                    Alamat</a>
